...
#ifndef MENUSIFU_SYNTHESIZE_SINGLETON_FOR_CLASS
...
#define MENUSIFU_SYNTHESIZE_SINGLETON_FOR_CLASS_HEADER(__CLASSNAME__)	\
	\
+ (__CLASSNAME__*) sharedInstance;	\


#define MENUSIFU_SYNTHESIZE_SINGLETON_FOR_CLASS(__CLASSNAME__)	\
	\
