...
- (NSString *)trimWhitespace {
    NSString *string = [self stringByReplacingOccurrencesOfString:@"\n" withString:STRING_NULL];
    string = [string stringByReplacingOccurrencesOfString:@"\t" withString:STRING_NULL];
    string = [string stringByReplacingOccurrencesOfString:@"\r" withString:STRING_NULL];
    string = [string stringByReplacingOccurrencesOfString:@" " withString:STRING_NULL];
