...
#import <float.h>
#define kCompresseionDataLength (100000.0f) //最大压缩大小(10k)

@implementation UIImage (Extran)
...
+ (UIImage*)circleImage:(UIImage*)image withParam:(CGFloat)inset
{
    ...
    CGContextSetStrokeColorWithColor(context, [UIColor whiteColor].CGColor);//切图边框线
