...
typedef void (^ExIndexChangeBlock)(NSInteger exIndex, NSInteger index);

typedef enum {
    HMSegmentedControlSelectionStyleTextWidthStripe, // Indicator width will only be as big as the text width
    HMSegmentedControlSelectionStyleFullWidthStripe, // Indicator width will fill the whole segment
    HMSegmentedControlSelectionStyleFullWidthAlignmentStripe,
    HMSegmentedControlSelectionStyleNoStripe,
...
@property (nonatomic, strong) UIImage *separatorLine;
...
@property (nonatomic, copy) ExIndexChangeBlock exIndexChangeBlock;
...
- (void)setExIndexChangeBlock:(ExIndexChangeBlock)exIndexChangeBlock;
